...
- **Architecture alignment**: Plans must respect `AGENTS.md` § Architecture — `cli.py` is a thin dispatcher, logic lives in `src/mnemoq/engine/` modules, ctx dict + Paths pattern.
...
1. `.opencode/plans/` — Windsurf-native plans
