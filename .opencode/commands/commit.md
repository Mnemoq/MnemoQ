...
|-------------------|---------------------------|
| `src/mnemoq/cli.py` | `docs/cli-reference.md`, `README.md` |
| `src/mnemoq/engine/constants.py` | `docs/config-tuning.md`, `docs/data-schema.md` |
| `src/mnemoq/engine/validation.py` | `docs/data-schema.md` |
| `src/mnemoq/engine/retrieval.py` | `docs/architecture-overview.md` |
| `src/mnemoq/engine/server.py` | `docs/architecture-overview.md` (access surfaces) |
| `src/mnemoq/engine/mcp_server.py` | `docs/mcp-integration.md`, `docs/architecture-overview.md` |
| `src/mnemoq/sdk/client.py` | `docs/sdk-guide.md` |
| `src/mnemoq/engine/dashboard_api.py` | `docs/architecture-overview.md` |
| `src/mnemoq/engine/consolidation.py` | `docs/architecture-overview.md` |
