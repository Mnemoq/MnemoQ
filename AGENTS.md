...
Exception: `tests/test_pure_functions.py` may import pure functions directly from engine modules (validation, retrieval, consolidation, auto_learn, evaluate) for unit testing without side effects.
