...
from mnemoq.engine.constants import EMBEDDING_CACHE_DIR, EMBEDDING_MODEL
from mnemoq.engine.io import read_learnings, write_learnings
from mnemoq.engine.metrics import log_event
from mnemoq.engine.profile import get_profile_context, load_profile
from mnemoq.engine.triggers import check_sleep_cycle
...
def retrieve_core(current_step, task_components, task_files, task_domain, ctx, paths, no_profile=False):
    ...
    if reranker_mode != "none":
        from mnemoq.engine.reranker import rerank as _rerank
