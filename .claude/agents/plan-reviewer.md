...
- **Plan deviations**: Plans should acknowledge the `.claude/agents/plan-deviation.md` procedure for surfacing deviations during implementation.
...
1. `Plans/` — repo-level plans
2. `nimbalyst-local/plans/` — session plans from Claude Code
